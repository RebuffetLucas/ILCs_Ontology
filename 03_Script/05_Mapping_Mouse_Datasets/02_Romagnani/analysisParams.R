...
SUB_ANALYSIS_STEP_NAME = "02_Romagnani"


SAMPLE_ANALYSIS = SAMPLE_ROMAGNANI
...
DO_SAVE_FIGURE = TRUE 
SAVE_FIG_PATH = "/mnt/DOSI/EVLAB/BIOINFO/BIOINFO_PROJECT/ILCs_Ontology/05_Output/05_Mapping_Mouse_Datasets/Figures/Figures_From_Chiara_Data/"
...
#Destiny Params
SUBSETS_TO_REMOVE = c( "prol. ILC2"  ,  "prol. ILC1"  ,  "prol. ILC3" )


#Destiny analysis

PATH_ROMAGNANI_DESTINY_ANALYSIS_OUTPUT = "/mnt/DOSI/EVLAB/BIOINFO/BIOINFO_PROJECT/ILCs_Ontology/05_Output/05_Mapping_Mouse_Datasets/Figures/Figures_From_Chiara_Data/Destiny_analysis"
