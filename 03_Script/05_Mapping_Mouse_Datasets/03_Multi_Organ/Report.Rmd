...
read_chunk( path=file.path( WORKING_DIR, "01a_PCA_AcrossSamples.R"));
read_chunk( path=file.path( WORKING_DIR, "01b_PCA_Dataviz.R"));
read_chunk( path=file.path( WORKING_DIR, "02a_Harmony_Across_Organs.R"));
read_chunk( path=file.path( WORKING_DIR, "02b_Harmony_Diagnostic.R"));
```
