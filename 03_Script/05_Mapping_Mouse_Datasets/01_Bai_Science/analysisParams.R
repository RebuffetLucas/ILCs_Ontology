...
SUB_ANALYSIS_STEP_NAME = "01_Bai_Science"


SAMPLE_ANALYSIS = SAMPLE_Bai
...
ANNOTATION_OF_INTEREST = "seurat_clusters"
...
DO_SAVE_FIGURE = TRUE 
SAVE_FIG_PATH = "/mnt/DOSI/EVLAB/BIOINFO/BIOINFO_PROJECT/ILCs_Ontology/05_Output/05_Mapping_Mouse_Datasets/Figures/Figure_From_Bai_Data"
