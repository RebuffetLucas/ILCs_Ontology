...
GLOBAL_DESCRIPTION = "This project aims at describing ILCs ontology. They originate from ILCs in the Liver that will seed different tissues
                      and differenciate into more specified kinds of ILC progenitors"
...
# Example : "moFluMemB"
SCIENTIFIC_PROJECT_NAME = "ILCs_Ontology"
...
EXPERIMENT_NAME = "Public_Data_Mapping_Results"
...
PATH_ANALYSIS_OUTPUT = PATH_EXPERIMENT_OUTPUT
